...
`{r. include=FALSE} df4<- df4 |> select(-c("race_ethnicityn", "race_ethnicityE"))`
...
# Data Exploration with Unsupervised Methods (PCA and Clustering)
...
## PCA: Generating and Visualizing Principle Components
...
## K-means Clustering: Ideal Number of Clusters
...
## K-Means Clustering on First 2 Principal Components
...
## Impact of Variables on the First Principle Component
...
## Partial Least Squares Prediction for GPA
...
# Variable Selection for Supervised Methods
...
# Regression for Identifying Important Predictors of Academic Success
...
## Choosing the Most Effective Linear Method
...
## Extracting Insight And Evaluating Chosen Linear Method
...
# Linear Classification for Evaluating Predictive Accuracy of GPA Predictors
...
# Classification Analysis and Visualization with Tree-Based Methods and SVM
...
## Deep Learning for Analyzing Specific GPA Scores
...
This project explored how different factors could contribute to student performance. Many more opportunities exist for expanding future research to understand a student's success of comprehensively. 
...
Conducting further research to intigrate these additional factors could help further our understanding of what contributes to the academic performance of students. With this deeper knowledge, educational strategies could be designed to better support a diverse student population. 

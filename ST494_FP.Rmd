---
title: "Understanding Academic Success with Statistical Learning"
...
df4 |> select(1:7) |> head(2)
df4 |> select(8:14) |> head(2)
df4 |> select(14:20) |> head(2)
```
...
pca_tst <- df_test |> select(-c(gpa, gpa_letter, gpa_desirable))
```
